...
import RoundIcon from '@/components/RoundIcon'; // Убедитесь, что путь правильный
                ...
                >
                    ...
                    <View style={styles.socialGridButtons}>
                        <TouchableOpacity onPress={handleGoogleLogin}>
                            <RoundIcon style={styles.socialButtons} IconComponent={Facebook} size={50} color="#fff" backgroundColor="#333144" />
                        </TouchableOpacity>
                        <TouchableOpacity onPress={handleGithubLogin}>
                            <RoundIcon style={styles.socialButtons} IconComponent={Github} size={50} color="#fff" backgroundColor="#333144" />
                        </TouchableOpacity>
                    </View>
